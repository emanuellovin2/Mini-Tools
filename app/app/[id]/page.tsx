    ...
    if (checkout === "cancel") {
      return (
        <div className="flex flex-col items-end gap-1">
          <p className="text-xs text-gray-400">Checkout cancelled.</p>
    ...
    if (hasActiveSub) {
      return (
        <div className="text-right">
          ...
          <div>
            <Link href="/buyer" className="text-xs text-gray-400 underline">
              Go to dashboard →
            </Link>
          </div>
        </div>
    ...
    <div className="max-w-2xl mx-auto px-4 py-10">
      ...
      <div className="border border-gray-200 rounded-2xl p-8">
        <div className="flex items-start justify-between gap-4 mb-2">
          ...
          {app.category && (
            <span className="shrink-0 text-sm bg-gray-100 text-gray-500 px-3 py-1 rounded-full">
              {app.category}
            </span>
          )}
        </div>
        ...
        {app.vendor_name && (
          <p className="text-sm text-gray-400 mb-5">by {app.vendor_name}</p>
        )}
