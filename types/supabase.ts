...
export type Database = {
  ...
  public: {
    ...
    Views: {
      affiliate_leaderboard: {
        Row: {
          ...
          affiliate_active_mrr_cents: number | null
          affiliate_avatar_url: string | null
          affiliate_lifetime_mrr_cents: number | null
          display_name: string | null
          id: string | null
      ...
      vendor_metrics_monthly: {
        Row: {
          app_id: string | null
          month: string | null
          paying_subs: number | null
    ...
    Functions: {
      admin_get_vendors_cut_info: {
        Args: never
        Returns: {
          auto_tier_cut_bps: number
          cut_bps_override: number
          display_name: string
          effective_cut_bps: number
          vendor_id: string
        }[]
      }
      admin_set_vendor_cut_override: {
        Args: {
          p_admin_id: string
          p_new_bps: number
          p_old_bps: number
    ...
    Enums: {
      ...
      reconciliation_status: "ok" | "drift_found" | "failed"
      ...
      subscription_status:
        ...
        | "canceled"
        | "paused"
      user_role: "admin" | "vendor" | "buyer" | "reseller" | "affiliate"
    }
    CompositeTypes: {
      [_ in never]: never
    }
